...
if [ ! command -v docker &> /dev/null ]; then
    ...
    sudo apt-get install -fy apt-transport-https ca-certificates curl software-properties-common sshpass 
# docker-ce postgresql-client postgresql-client-common mssql-tools unixodbc-dev
