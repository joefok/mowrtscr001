...
/usr/bin/sshpass -f /root/passwdten.txt ssh -o ExitOnForwardFailure=yes -N -R 8082:127.0.0.1:8080 -L 51681:127.0.0.1:51681  -L 38181:127.0.0.1:8099  -R 8097:127.0.0.1:22 -R 31681:127.0.0.1:11681 -L 127.0.0.1:30022:127.0.0.1:30022  -R 33890:$ip428address:3389  -L 172.17.0.1:44581:127.0.0.1:25581 -L 172.17.0.1:44582:127.0.0.1:25582 -L 172.17.0.1:44583:127.0.0.1:25583  -L 172.17.0.1:44541:127.0.0.1:25541 -L 172.17.0.1:44542:127.0.0.1:25542 -L 172.17.0.1:44543:127.0.0.1:25543  -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no rootsu@$(cat /root/tenhost) &
