...
sshpass -f /root/passwdten.txt ssh -y -y -o "ServerAliveInterval 300" -o "ServerAliveCountMax 5" -o "ExitOnForwardFailure yes" -N -R 41820:192.168.8.182:22 -R 41819:192.168.8.182:8080 -R 48171:192.168.8.171:5900 -R 51681:192.168.8.100:11681 -R 25539:127.0.0.1:25540 -L 0.0.0.0:25540:127.0.0.1:8080 -R 25581:192.168.8.103:80   -R 25582:192.168.8.106:80  -R 25583:192.168.8.176:80  -R 25541:192.168.8.103:554  -R 25542:192.168.8.106:554 -R 25543:192.168.8.176:554  -R 41818:192.168.8.114:8080 -R 41622:192.168.8.114:22 -R 127.0.0.1:30023:127.0.0.1:22 -R 30022:192.168.8.100:22 -L 8002:127.0.0.1:8001  -R 3389:192.168.8.105:3389 -R 8001:192.168.8.1:80 rootsu@$(cat /root/tenhost) &
fi;
