...
rm /root/.ssh/known_hosts; sshpass -f /root/ubpwd ssh -y -N -o ExitOnForwardFailure=yes -R 39282:127.0.0.1:22 -L 0.0.0.0:51722:127.0.0.1:51722 -L 0.0.0.0:8080:127.0.0.1:51782 -L 0.0.0.0:51782:127.0.0.1:51782 rootsu@$(cat /root/ubhost) -p 60922&
